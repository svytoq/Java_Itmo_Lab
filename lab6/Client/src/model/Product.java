...
public class Product implements Comparable<Product>, Serializable {
        ...
        public Product(int id, String name, Coordinates coordinates, LocalDateTime creationDate, Double price, String partNumber, double manufactureCost, UnitOfMeasure unitOfMeasure, Person owner) {
                this.id = id;
                this.name = name;
